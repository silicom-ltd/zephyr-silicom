...
#ifndef ZEPHYR_INCLUDE_DRIVERS_PWM_EMC230X_H_
#define ZEPHYR_INCLUDE_DRIVERS_PWM_EMC230X_H_

/**
 * @name custom PWM flags for EMC230X
 * These flags can be used with the PWM API in the upper 8 bits of pwm_flags_t
 * They allow the usage of the RPM mode, which will cause the EMC230X to
 * measure the actual speed of the fan and automatically control it to the
 * desired speed.
 * @{
 */
/** @cond INTERNAL_HIDDEN */
#define PWM_EMC230X_FLAG_RPM_MODE_POS		 8
#define PWM_EMC230X_FLAG_SPEED_RANGE_POS	 9
#define PWM_EMC230X_FLAG_PWM_RATE_OF_CHANGE_POS 12
#define PWM_EMC230X_FLAG_SPIN_UP_POS		 15
/** @endcond */
 ...
 * can be found in the datasheet of the EMC230X.
 */
 ...
 */
#define PWM_EMC230X_FLAG_SPIN_UP	       (1 << PWM_EMC230X_FLAG_SPIN_UP_POS)
/** @} */

#endif /* ZEPHYR_INCLUDE_DRIVERS_PWM_EMC230X_H_ */
